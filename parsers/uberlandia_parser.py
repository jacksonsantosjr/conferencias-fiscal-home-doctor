"""
Adaptador de Parser para a Prefeitura de Uberlândia (MG).
Extrai notas fiscais do relatório oficial da Prefeitura de Uberlândia (XLSX, CSV ou PDF),
...
class UberlandiaParser(BaseCityParser):
    def __init__(self):
        super().__init__("Uberlândia")
